...
export const ACADEMY_ACCESS_ROLES = [ROLES.ACADEMY_MNGR, ROLES.ADMIN, ROLES.ACADEMY_VISITOR] as const
...
export interface UserProfile {
  ...
  lastName: string
  roles: string[]
  primaryRole: 'HR' | 'CAND' | 'ACADEMY_MNGR' | 'MNGR' | 'ADMIN' | 'ACADEMY_VISITOR' | string
}
